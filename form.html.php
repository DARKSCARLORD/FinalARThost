...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Prepare and bind
    $query = $conn->prepare("INSERT INTO Art_Submissions (FirstName, LastName, PhoneNumber, EmailAddress, ArtStyle, ArtworkImages, Questions) VALUES (?, ?, ?, ?, ?, ?, ?)");
    $query->bind_param('sssssss', $firstName, $lastName, $phoneNumber, $emailAddress, $artStyle, $uploadedFilesJson, $questions);
    $query->execute();
    $query->close();
}
